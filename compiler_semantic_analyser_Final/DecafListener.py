...
class DecafListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by DecafParser#values_of_varible.
    def enterValues_of_varible(self, ctx:DecafParser.Values_of_varibleContext):
        pass

    # Exit a parse tree produced by DecafParser#values_of_varible.
    def exitValues_of_varible(self, ctx:DecafParser.Values_of_varibleContext):
        pass
