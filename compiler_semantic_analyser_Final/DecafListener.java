...
public interface DecafListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DecafParser#values_of_varible}.
	 * @param ctx the parse tree
	 */
	void enterValues_of_varible(DecafParser.Values_of_varibleContext ctx);
	/**
	 * Exit a parse tree produced by {@link DecafParser#values_of_varible}.
	 * @param ctx the parse tree
	 */
	void exitValues_of_varible(DecafParser.Values_of_varibleContext ctx);
}