...
class DecafVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by DecafParser#string_literal.
    ...
    # Visit a parse tree produced by DecafParser#values_of_varible.
    def visitValues_of_varible(self, ctx:DecafParser.Values_of_varibleContext):
        return self.visitChildren(ctx)
